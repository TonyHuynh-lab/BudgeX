...
export default function Stocks(): React.JSX.Element {
  ...
  const handleEditPositionAccount = async (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    await update({
      ...editingPosition,
      accountId: editAccountValue === 'unassigned' ? null : Number(editAccountValue)
    })
  ...
  return (
    <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => setForm({ ...form, avgCostBasis: e.target.value })}
                    required
                  />
                </div>
                <div className="space-y-1">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card>
          <CardHeader className="pb-1">
            ...
            <CardTitle
              className={`text-3xl font-mono ${totalPnL >= 0 ? 'text-green-500' : 'text-red-500'}`}
            >
              {totalPnL >= 0 ? '+' : ''}
                    ...
                    filteredPositions.map((s) => {
                      ...
                      return (
                        <TableRow key={s.id}>
                          ...
                          <TableCell
                            className={`text-right font-mono ${pnl >= 0 ? 'text-green-500' : 'text-red-500'}`}
                          >
                            {s.currentPrice > 0
                            ...
                            <div className="flex gap-1">
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  setEditAccountValue(
                                    s.accountId ? String(s.accountId) : 'unassigned'
                                  )
                                }}
                              >
                                Edit Account
      ...
      <Dialog
        open={editAccountPositionId !== null}
        onOpenChange={(o) => !o && setEditAccountPositionId(null)}
      >
        <DialogContent>
          <DialogHeader>
